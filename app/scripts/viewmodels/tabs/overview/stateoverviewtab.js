define(["viewmodels/tabs/overview/overviewtab"], function(OverviewTab) {"use strict";
    ...
    function StateOverviewTab(setTabSelection, parentView) {
        var self = this;
        OverviewTab.call(self, setTabSelection, parentView);

        self.ViewType = "StateOverviewTab";
    ...
    // Create inheritance
    if (Object.create) {
        StateOverviewTab.prototype = Object.create(OverviewTab.prototype);
    }
    return (StateOverviewTab);
