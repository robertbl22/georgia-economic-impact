define(["viewmodels/tabs/overview/overviewtab"], function(OverviewTab) {"use strict";
    ...
    function RegionOverviewTab(setTabSelection, parentView) {
        var self = this;
        OverviewTab.call(self, setTabSelection, parentView);

        self.ViewType = "RegionOverviewTab";
        ...
        function drawPercentOfStateChart($ParentContainer, data) {
            var r1 = ["Direction", "Total Value"];
            var r2 = ["Region Est. Value", data.TotalEstValue];
    ...
    // Create inheritance
    if (Object.create) {
        RegionOverviewTab.prototype = Object.create(OverviewTab.prototype);
    }
    return (RegionOverviewTab);
